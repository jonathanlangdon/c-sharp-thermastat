...
public sealed class DownstairsSensorBackgroundServiceTests
{
    [Fact]
    public async Task StartAsync_RefreshesSensorImmediately()
    {
        var updater = new FakeDownstairsSensorUpdater();
        var service = new DownstairsSensorBackgroundService(
            updater,
    ...
    private sealed class FakeDownstairsSensorUpdater : IDownstairsSensorUpdater
    {
